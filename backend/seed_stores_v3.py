...
async def seed_stores_v3():
    ...
    # 1. SAFEWAY (Updated with Pet, International, Sauce)
    safeway = Store(
        name="Safeway",
        ...
        aisles=[
            ...
            Aisle(name="Aisle 2", order=11, categories=["Baking", "Spices", "Condiments", "Sauces", "Oil"], x=39, y=25, width=5, height=45, orientation="vertical"), # Hot Sauce here
            ...
            Aisle(name="Aisle 5", order=14, categories=["Beverages", "Soda", "Water", "Juice", "Pet Care", "Dog Food", "Cat Food"], x=60, y=25, width=5, height=45, orientation="vertical"), # Pet here
